...
plt.plot(x_axs, grouped_users_df, linewidth=3, linestyle='dotted', color='#44779A', marker='o', markerfacecolor='#7DFAC2')
for i in range(len(months)):
    plt.annotate(text=grouped_users_df[i], xy=(x_axs[i], grouped_users_df[i]), fontsize='small', fontweight='bold', fontstyle='oblique')
